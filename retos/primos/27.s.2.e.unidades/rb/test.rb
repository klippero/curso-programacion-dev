...
puts Fraccion.new(5,4).unidades
puts Fraccion.new(11,5).unidades
puts Fraccion.new(-17,5).unidades
puts Fraccion.new(-1,5).unidades
puts Fraccion.new(-6,-5).unidades
